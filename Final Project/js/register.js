...
$(document).ready(function(){
    ...
    *******************/
	function printInfo(dictUserInfo) {
		alert("Username: " + dictUserInfo["userName"]+"\n"+
				"First Name" +dictUserInfo["firstName"]+
				"lastName"+dictUserInfo["lastName"]+
				"postfix"+dictUserInfo["postfix"]+
				"realNameVisible"+dictUserInfo["realNameVisible"]+
				"pronounce"+dictUserInfo["pronounce"]+
				"birthDate"+dictUserInfo["birthDate"]+
				"email"+dictUserInfo["email"]+
				"phone"+dictUserInfo["phone"]+
				"country"+dictUserInfo["country"]+
				"address1"+dictUserInfo["address1"]+
				"address2"+dictUserInfo["address2"]+
				"city"+dictUserInfo["city"]+
				"state"+dictUserInfo["state"]+
				"zipcode"+dictUserInfo["zipcode"]+
				"profession"+dictUserInfo["profession"]+
				"careerYears"+dictUserInfo["careerYears"]+
				"Bios"+dictUserInfo["bio"]
				)
	}
	/******************
    NAME: submit
